...
window.addEventListener('DOMContentLoaded', () => {
  ...
  localStorage.removeItem('reloadReason');
    ...
    firstText.innerHTML = 'Привет, выход из тюряги, это сложно, но нужно как-то жить дальше. Из хорошего - у тебя осталась квартирка, но район такой себе, с повышенной преступностью. Нет времени объяснять, тут разобраться не сложно. Всё, что тебе нужно знать: <br> <br> 1. Каждый поход в одно из четырёх мест уменьшает сытость на 1. <br> <br>2. Как только любая из характеристик станет равна нулю - игра закончится. <br> <br>Удачи!'
  };
});
